...
export default function DashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-background text-on-background bg-grid-pattern flex">
      {/* Sidebar Navigation */}
      <div className="w-64 bg-pure-white border-r border-primary flex flex-col hidden md:flex">
        <div className="p-6 border-b border-primary flex items-center gap-2 font-bold tracking-tight text-primary">
