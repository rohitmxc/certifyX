...
import { ArrowRight, ShieldCheck, QrCode, CloudLightning, Scan, Box, Cpu, FileText } from "lucide-react";
      ...
      <header className="fixed top-0 w-full z-50 bg-background/90 backdrop-blur-md border-b border-outline-variant/30 transition-all duration-300">
        <div className="max-w-[1280px] mx-auto px-margin h-16 flex justify-between items-center px-4 md:px-8">
          <div className="flex items-center gap-3">
            ...
            <span className="font-dot text-[12px] text-outline uppercase border border-outline-variant px-1 rounded-none">BETA</span>
          </div>
          <nav className="hidden md:flex items-center gap-8">
            ...
            {isConnected && (
              <>
                <Link className="text-primary font-dot text-[16px] uppercase border-b-2 border-primary pb-0.5" href="/dashboard/issue">Dashboard</Link>
